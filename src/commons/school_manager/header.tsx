    ...
    <div className="w-full min-h-[50px] bg-primary-400 flex flex-row justify-between items-center pl-[1.5vw] pr-2">
      ...
      <div className="flex flex-row justify-end items-center gap-3">
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 top-12 w-80 bg-white rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto no-scrollbar">
              <div className="p-4">
                ...
                <Tabs
                  ...
                  sx={{
                    ...
                    "& .MuiTabs-indicator": {
                      backgroundColor: "var(--secondary-light-hover)",
                    },
                  }}
                >
                  <Tab label="Hôm nay" />
