		...
		<div className='relative w-[16%] h-screen flex flex-col justify-start items-start gap-5 bg-white'>
			...
			<div className='w-full h-fit py-[70px] flex flex-col justify-start items-center overflow-y-scroll no-scrollbar'>
				{SM_SIDENAV.map((category: ISMSidenav) => (
					...
					>
						<div className='w-full h-fit pl-2 pr-3 py-2 flex flex-row justify-between items-center hover:bg-basic-gray-hover hover:cursor-pointer'>
			...
			<div className='absolute bottom-0 right-0 w-full h-fit flex justify-center items-center bg-white py-3 border-t-1 border-gray-400'>
				<button
