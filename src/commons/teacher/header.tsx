...
import { ITeacherState, toggleMenu } from '@/context/slice_teacher';
...
const TeacherHeader = ({ children }: { children: ReactNode }) => {
	const { selectedSchoolYearId, setSelectedSchoolYearId, userRole, sessionToken } = useAppContext();
	...
	const { isMenuOpen }: ITeacherState = useTeacherSelector((state) => state.teacher);
