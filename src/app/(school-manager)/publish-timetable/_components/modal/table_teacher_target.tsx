...
import { IPeriodProcessData, ISwitchPeriod, ITimetableProcessData } from '../../_libs/constants';
...
const isDoubleSlot = (data: IPeriodProcessData[], existingSlot: IPeriodProcessData): boolean => {
	const eSlots: IPeriodProcessData[] = data.filter(
...
interface ITeacherSelectTableProps {
	...
	selectedSlotUnavailability: IPeriodProcessData[];
...
const TeacherTargetTable = (props: ITeacherSelectTableProps) => {
	...
	const handleSelectTarget = (slot: IPeriodProcessData) => {
