...
interface IPublishTimetableCancelConfirmModalProps {
	open: boolean;
	setOpen: (status: boolean) => void;
	handleApprove: () => void;
}

const PublishTimetableCancelConfirmModal = (props: IPublishTimetableCancelConfirmModalProps) => {
...
export default PublishTimetableCancelConfirmModal;
