...
interface ITeacherConfirmModalProps {
	open: boolean;
	setOpen: React.Dispatch<React.SetStateAction<boolean>>;
	handleConfirm: () => void;
}

const TeacherConfirmModal = (props: ITeacherConfirmModalProps) => {
		...
		>
			<Box sx={style}>
				...
				<div className='w-full h-fit min-h-[10vh] p-3 flex flex-col justify-center items-start '>
					<h1 className='text-body-large-strong'>Xác nhận tạo tài khoản giáo viên?</h1>
				</div>
				<div
					id='modal-footer'
