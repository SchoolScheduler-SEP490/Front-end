...
interface ITeacherActiveModalProps {
	open: boolean;
...
const TeacherActiveModal = (props: ITeacherActiveModalProps) => {
			...
			<Box sx={style}>
				...
				<div className='w-full h-fit min-h-[10vh] p-3 flex flex-col justify-center items-start '>
					<h1 className='text-body-large-strong'>
						Xác nhận khôi phục tài khoản cho giáo viên <strong>{selectedTeacherName}</strong>?
					</h1>
				</div>
				<div
					id='modal-footer'
				...
				>
					...
					<ContainedButton
						...
						type='button'
						styles='!bg-basic-positive !text-white !py-1 px-3'
...
export default TeacherActiveModal;
