        ...
        {teacherData && (
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-6 leading-loose">
              <div>
                <p>
                  <strong>Họ:</strong> {teacherData["first-name"]}
                </p>
                <p>
                  <strong>Giới tính:</strong> {teacherData.gender}
                </p>
                <p>
              ...
              <div>
                <p>
                  <strong>Tên:</strong> {teacherData["last-name"]}
                </p>
                <p>
                ...
                <p>
                  <strong>Số điện thoại:</strong> {teacherData.phone}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-6 leading-loose">
              <div>
                <p>
                  <strong>Tên viết tắt:</strong> {teacherData.abbreviation}
                </p>
                <p>
                  <strong>Dạy môn:</strong>{" "}
              ...
              <div>
                <p>
                  ...
                  {teacherData["teacher-role"] === "Role1"
                    ? "Giáo viên"
                    : "Trưởng bộ môn"}
                </p>
                <p>
                  <strong>Tổ bộ môn:</strong> {teacherData["department-name"]}
                </p>
                <p>
                  <strong>Trạng thái:</strong>{" "}
                  {TEACHER_STATUS_TRANSLATOR[teacherData.status]}
                </p>
              </div>
            </div>
          </div>
