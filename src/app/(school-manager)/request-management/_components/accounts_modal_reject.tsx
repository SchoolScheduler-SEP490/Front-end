...
interface IRequestRejectModalProps {
	open: boolean;
...
const RequestRejectModal = (props: IRequestRejectModalProps) => {
		...
		>
			<Box sx={style}>
				...
				<div className='w-full h-fit min-h-[10vh] p-3 flex flex-col justify-center items-start gap-3'>
					<h1 className='text-body-large-strong'>Từ chối yêu cầu của giáo viên?</h1>
					<TextField
						label='Nhập ghi chú'
