...
const TimetableConfirmModal = (props: ICurriculumConfirmModalProps) => {
	const { message, handleConfirm, setOpen, open } = props;
		...
		>
			<Box sx={style}>
				...
				<div className='w-full h-fit px-5 py-[3vh]'>
					<h2 className='text-title-small font-normal w-full text-left'>{message}</h2>
				</div>
				<div
					id='modal-footer'
...
export default TimetableConfirmModal;
