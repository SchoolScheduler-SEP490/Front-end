import { IClassResponse, ITeachersLessonsSidenavData } from '../_libs/constants';
...
const useSidenavDataConverter = (data: IClassResponse[]): ITeachersLessonsSidenavData[] => {
	...
	const groupedData = data.reduce<{ [key: string]: ITeachersLessonsSidenavData }>((acc, item) => {
