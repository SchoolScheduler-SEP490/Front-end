'use client';
import { IRegisterForm, IRegisterResponse } from '@/app/(auth)/_utils/constants';
import { useAppContext } from '@/context/app_provider';
import { inter } from '@/utils/fonts';
import { FormControl, IconButton, InputLabel, Select, styled } from '@mui/material';
...
export const RegisterForm = () => {
	...
	const handleRegister = async ({ email, phone, password, confirm }: IRegisterForm) => {
		try {
