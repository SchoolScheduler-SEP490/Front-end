...
interface IDashboardConfirmModalProps {
	open: boolean;
	setOpen: React.Dispatch<React.SetStateAction<boolean>>;
	handleConfirm: () => void;
}

const DashboardConfirmModal = (props: IDashboardConfirmModalProps) => {
		...
		>
			<Box sx={style}>
				...
				<div className='w-full h-fit min-h-[10vh] p-3 flex flex-col justify-center items-start '>
					<h1 className='text-body-large-strong'>Xác nhận yêu cầu tạo tài khoản?</h1>
				</div>
				<div
					id='modal-footer'
...
export default DashboardConfirmModal;
