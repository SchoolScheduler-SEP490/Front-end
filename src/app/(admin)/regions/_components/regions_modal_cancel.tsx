...
interface IRegionsCancelConfirmModalProps {
	open: boolean;
	setOpen: (status: boolean) => void;
	handleApprove: () => void;
}

const RegionsCancelConfirmModal = (props: IRegionsCancelConfirmModalProps) => {
...
export default RegionsCancelConfirmModal;
