...
interface IAccountActiveModalProps {
	open: boolean;
...
const AccountActiveModal = (props: IAccountActiveModalProps) => {
			...
			<Box sx={style}>
				...
				<div className='w-full h-fit min-h-[10vh] p-3 flex flex-col justify-center items-start '>
					<h1 className='text-body-large-strong'>
						Xác nhận khôi phục tài khoản <strong>{selectedAccountName}</strong>?
					</h1>
				</div>
				<div
					id='modal-footer'
...
export default AccountActiveModal;
